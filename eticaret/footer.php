...
<div class="footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            <h2>Güvenli Ödeme</h2>
                                            <p>Kart ile güvenli bir şekilde ödemelerinizi gerçekleştirebilirsiniz.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            <h2>Orjinal Ürünler</h2>
                                            <p>Tüm ürünlerimiz %100 orjinal ürünlerdir.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p>Her türlü sorununuz için canlı destekten yardım alabilirsiniz.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                ...
                <div class="footer-static-middle">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        ...
                                        <li>
                                            <span>Phone: </span>
                                           <a href="tel://<?php echo $ayarcek['telefon'] ?>">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        ...
                                        <ul>
                                            <?php       $kategori=$baglanti->prepare("SELECT * FROM  kategori  order by kategori_sira ASC limit 5");
                  $kategori->execute();
                  while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        <h3 class="footer-block-title">Ne Ararsan</h3>
                                        <ul>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center pt-25">
                                    <span><a target="_blank" href="https://www.linkedin.com/in/damla-geyik-59562720b/">Damla Geyik</a></span>
                                </div>

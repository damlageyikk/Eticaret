            ...
            <label>Hakkımızda Detay</label>
              ...
              <input type="hidden" name="katsid" value="<?php echo $_GET['katid'] ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input  name="urunlersira" type="text" class="form-control"  placeholder="Sırasını giriniz.">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">urunler model</label>
                    <input  name="urunlermodel" type="text" class="form-control"  placeholder="Modelini giriniz.">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">urunler renk</label>
                    <input  name="urunlerrenk" type="text" class="form-control"  placeholder="Rengini giriniz.">
                  </div>
             
               <div class="form-group">
                    <label for="exampleInputPassword1">urunler adet</label>
                    <input  name="urunleradet" type="text" class="form-control"  placeholder="Adetini giriniz.">
                  </div>
             
                  <div class="form-group">
                    <label for="exampleInputPassword1">urunler fiyat</label>
                    <input  name="urunlerfiyat" type="text" class="form-control"  placeholder="Fiyatını giriniz.">
                  </div>
                       <div class="form-group">
                    <label for="exampleInputPassword1">urunler anahtar kelime</label>
                    <input  name="urunleranahtar" type="text" class="form-control"  placeholder="Anahtar kelimeyi giriniz.">
                  </div>
                  <div class="form-group">

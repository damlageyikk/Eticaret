...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Ne</b> Ararsan</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
  ...
  if(@$_GET['durum']=="hata"){  ?>
   ...
   elseif(@$_GET['durum']=="cikis"){  ?>
      <p style="color:red;" class="login-box-msg">Tekrar giriş yapın.
     <?php  }
   else {
...
?>
      ...
      <form action="modals/islem.php" method="post">
        ...
        <div class="input-group mb-3">
          <input name="sifre" type="password" class="form-control" placeholder="Şifreninizi giriniz">
          <div class="input-group-append">
            <div class="input-group-text">
